...
from dataset import get_dataloaders, get_num_class, get_label_name, get_dataset_dimension,get_num_channel,Freq_dict,TimeS_dict
...
class RayModel(WandbTrainableMixin, tune.Trainable):
    def setup(self, *_args): #use new setup replace _setup
        ...
        self.train_queue, self.valid_queue, self.search_queue, self.test_queue, self.tr_search_queue, preprocessors = get_dataloaders(
        ...
        self.task_model = get_model(model_name=args.gf_model_name,
        ...
        self.gf_model = get_model(model_name=args.gf_model_name,
                                num_class=search_n_class,
                                use_cuda=True, data_parallel=False)
        ...
        if args.keep_mode=='adapt':
            ...
            self.adaaug = AdaAugkeep_TS(after_transforms=after_transforms,
                ...
                policy_class_adaptive=args.class_adapt,
