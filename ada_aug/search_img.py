...
def main():
    ...
    train_queue, valid_queue, search_queue, test_queue, tr_search_queue = get_dataloaders(
        args.dataset, args.batch_size, args.num_workers,
        args.dataroot, args.cutout, args.cutout_length,
        split=args.train_portion, split_idx=0, target_lb=-1,
        search=True, search_divider=sdiv,tr_search=True)
    ...
    for epoch in range(args.epochs):
        ...
        # searching
        train_acc, train_obj = train(train_queue, search_queue, tr_search_queue, gf_model, adaaug,
...
def train(train_queue, search_queue,tr_search_queue, gf_model, adaaug, criterion, gf_optimizer,
